...
\[INSERT IMPORTANT GEOGRAPHICAL VISUALIZATIONS HERE\]
...
There is a strange dip at shot 9 relative to shot 8 which we don't have a good explanation for. Beyond that, the model follows a rise from around ~70% accuracy in the earlier shots (a trend that would continue to stay true for shots 1 to 4) to around a stable 83% accuracy. 
...
[THIS IS A GREAT TIME TO MENTION THE CNN AND TALK ABOUT HOW IT DIDN'T WORK]
