...
if(Voronoi$Team1_Hammer == TRUE){
  Voronoi_team1_x <- c(Voronoi$stone_7_x, Voronoi$stone_8_x, Voronoi$stone_9_x, Voronoi$stone_10_x, Voronoi$stone_11_x, Voronoi$stone_12_x)
  Voronoi_team1_y <- c(Voronoi$stone_7_y, Voronoi$stone_8_y, Voronoi$stone_9_y, Voronoi$stone_10_y, Voronoi$stone_11_y, Voronoi$stone_12_y)
  Voronoi_team2_x <- c(Voronoi$stone_1_x, Voronoi$stone_2_x, Voronoi$stone_3_x, Voronoi$stone_4_x, Voronoi$stone_5_x, Voronoi$stone_6_x)
  Voronoi_team2_y <- c(Voronoi$stone_1_y, Voronoi$stone_2_y, Voronoi$stone_3_y, Voronoi$stone_4_y, Voronoi$stone_5_y, Voronoi$stone_6_y)
} else {
